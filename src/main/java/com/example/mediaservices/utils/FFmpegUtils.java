package com.example.mediaservices.utils;


import com.example.mediaservices.domain.ImageMetaInfo;
import com.example.mediaservices.domain.MusicMetaInfo;
import com.example.mediaservices.domain.VideoMetaInfo;
import com.example.mediaservices.domain.gif.AnimatedGifEncoder;
...
public class FFmpegUtils {
    ...
    public static String getMetaInfoFromFFmpeg(File inputFile) {
        ...
        String executeResult = FFmpegUtils.executeCommand(commond);
